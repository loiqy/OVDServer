...
class OWLViTBackend(OVDBackend):
    model_names = [
        'owlvit-base-patch32',
        'owlvit-base-patch16',
    ...
    def load_model(self, model_name: str):
        ...
        self.processor: OwlViTProcessor = OwlViTProcessor.from_pretrained(model_id)
        self.model: OwlViTForObjectDetection = OwlViTForObjectDetection.from_pretrained(model_id).to(self.device)
